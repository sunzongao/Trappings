...
<link href="${pageContext.request.contextPath}/statics/skin/default/skin.css" rel="stylesheet" type="text/css" id="skin" />
...
<div class="login-container">
	<div class="center"> <img src="statics/images/logo.png" /></div>
							<div class="space-6"></div>
							<div class="position-relative">
								<div id="login-box" class="login-box widget-box no-border visible">				
                                  <div class="login-main">
                                  <div class="clearfix">
                                  <div class="login_icon"><img src="${pageContext.request.contextPath}/statics/images/login_img.png" /></div>
									<form class="" style=" width:300px; float:right; margin-right:50px;">
                                    <h4 class="title_name"><img src="statics/images/login_title.png" /></h4>
										<fieldset>
										<ul>
   ...
   <li class="frame_style form_error"><label class="Codes_icon"></label><input name="" type="text"   data-name="验证码" id="Codes_text"/><i>验证码</i><div class="Codes_region"><img id="imgObj" onclick="changeImg()" src="${pageContext.request.contextPath}/getCode" width="100%" height="38px"></div></li>  
  </ul>
    <div class="space"></div>
                              <div class="clearfix">
                                  <label class="inline">
                                      <input type="checkbox" id="remberme" class="ace">
          ...
          <!-- /widget-body -->
                        ...
                        <div class="loginbm">版权所有  2018  <a href=""></a> </div><strong></strong>
</body>
</html>
