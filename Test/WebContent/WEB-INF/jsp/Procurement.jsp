		...
		<form id="form1"
			...
			<div class="list_Exhibition list_show padding15">
				<div class="operation clearfix mb15  searchs_style">
					...
					<span class="submenu"> 
					<a href="add_Article.html" name="" class="btn button_btn bg-deep-blue" title="采购进货">
					<i class="fa  fa-edit"></i>&nbsp;采购进货</a>
					</span> 
					<label class="label_name">单据号：</label>
					<input name="procurementId" type="text" class="" />
					...
					<c:forEach items="${pageUtil.lists}" var="p">
						<tr>
							...
							<td class="td-manage"><a onClick="member_stop(this,'10001')"
								href="javascript:;" title="发布" class="btn btn-xs btn-status">发布</a>
								<a title="编辑"
								onclick="member_edit('编辑','add_Article.html','4','','510')"
