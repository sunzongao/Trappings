		...
		<form id="form1"
			...
			<div class="list_Exhibition list_show padding15">
				<div class="operation clearfix mb15  searchs_style">
					<span class="submenu"> <a href="${pageContext.request.contextPath}/jsp/procurement_toadd.html" name=""
						class="btn button_btn bg-deep-blue"  title="采购进货"> <i
					...
					<c:forEach items="${pageUtil.lists}" var="p">
						<tr>
							...
							<td class="td-manage"><a
								...
								href="javascript:;${p.procurementId}" class="btn btn-xs btn-info">查看</a>
								</td>
						</tr>
					</c:forEach>
