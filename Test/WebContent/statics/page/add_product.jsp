...
<script src="${pageContext.request.contextPath }/statics/js/hsCheckData.js" type="text/javascript"></script>
<!--[if lt IE 9]>
...
<div class="add_style clearfix relative">
 ...
 <div class="Button_operation btn_width">
   ...
   <!--复文本编辑框-->
    <script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath }/statics/js/utf8-jsp/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath }/statics/js/utf8-jsp/ueditor.all.min.js"> </script>
    <script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath }/statics/js/utf8-jsp/lang/zh-cn/zh-cn.js"></script>
<script>
var cityData=[
{
		"2":"食品/保健/酒/饮料",
