...
<script type="text/javascript">
    ...
    },
    {
    ...
    },
		{
		  ...
		  url:"${pageContext.request.contextPath }/statics/page/member_list.jsp",
		  name:'会员列表',
	...
	},
	{
		 ...
		 pid:1,
		 icon:'fa fa-angle-double-right',
		 url:"${pageContext.request.contextPath }/statics/page/index.jsp",
		 name:'首页',
  ...
  },
	{
		  ...
		  pid:2,
		  icon:'fa fa-angle-double-right',
		  url:'${pageContext.request.contextPath }/statics/page/add_product.jsp',
		  name:'添加商品',
	...
	},
	{
		 ...
		 pid:2,
		 icon:'fa fa-angle-double-right',
		 url:'${pageContext.request.contextPath }/statics/page/Brand_Manage.jsp',
		 name:'品牌管理',
  ...
  },
	{
		 ...
		 pid:2,
		 icon:'fa fa-angle-double-right',
		 url:'${pageContext.request.contextPath }/statics/page/Products.jsp',
		 name:'商品分类',
	...
	},
		{
		 ...
		 pid:7,
		 icon:'fa fa-angle-double-right',
		 url:'${pageContext.request.contextPath }/statics/page/admin_Competence.jsp',
		 name:'权限设置',
		 ...
		 pid:3,
		 icon:'fa fa-angle-double-right',
		 url:'${pageContext.request.contextPath }/statics/page/Order_form.jsp',
		 name:'订单管理',
		 ...
		 pid:3,
		 icon:'fa fa-angle-double-right',
		 url:'${pageContext.request.contextPath }/statics/page/Refund.jsp',
		 name:'退款管理',
		 ...
		 pid:7,
		 icon:'fa fa-angle-double-right',
		 url:'${pageContext.request.contextPath }/statics/page/administrator_list.jsp',
		 name:'管理员设置',
		 ...
		 pid:7,
		 icon:'fa fa-angle-double-right',
		 url:'${pageContext.request.contextPath }/statics/page/Personal_info.jsp',
		 name:'管理员信息',
  ...
  },
	{
		 ...
		 pid:3,
		 icon:'fa fa-angle-double-right',
		 url:'${pageContext.request.contextPath }/statics/page/Order_Logistics.jsp',
		 name:'物流管理',
		 ...
		 pid:10,
		 icon:'fa fa-angle-double-right',
		 url:'${pageContext.request.contextPath }/statics/page/Advertising_list.jsp',
		 name:'广告列表',
	...
	},
		{
		 ...
		 pid:10,
		 icon:'fa fa-angle-double-right',
		 url:'${pageContext.request.contextPath }/statics/page/Advertising_sort.jsp',
		 name:'广告分类',
		 ...
		 pid:5,
		 icon:'fa fa-angle-double-right',
		 url:'${pageContext.request.contextPath }/statics/page/system_columns.jsp',
		 name:'栏目设置',
	...
	},
		{
		 ...
		 pid:5,
		 icon:'fa fa-angle-double-right',
		 url:'${pageContext.request.contextPath }/statics/page/form_builder.jsp',
		 name:'自定页面',
	...
	},
		{
		 ...
		 pid:5,
		 icon:'fa fa-angle-double-right',
		 url:'${pageContext.request.contextPath }/statics/page/system_info.jsp',
		 name:'系统设置',
