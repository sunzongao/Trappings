    ...
    e.prototype = {
        init: function () {
            ...
            var a = this.opts,
                ...
                d = this.getPagesTpl(),
                e = this.ele.empty();
            this.isRender = !0, this.homePage = '<a href="javascript:void(0);" class="ui-pagination-page-item" data-current="1">' + a.homePageText + "</a>", this.prevPage = '<a href="javascript:void(0);" class="ui-pagination-page-item" data-current="' + (b - 1) + '">' + a.prevPageText + "</a>", this.nextPage = '<a href="javascript:void(0);" class="ui-pagination-page-item" id="next" data-current="' + (b + 1) + '">' + a.nextPageText + "</a>", this.endPage = '<a href="javascript:void(0);" class="ui-pagination-page-item"  id="end" data-current="' + c + '">' + a.endPageText + "</a>", this.checkPage(), this.isRender && e.html("<div class='ui-pagination-container'>" + this.homePage + this.prevPage + d + this.nextPage + this.endPage + "</div>")
        }, checkPage: function () {
            var a = this.opts,
                b = this.total,
                c = this.current;
